...
考虑到 go 语言团队已经在泛型实现上已经[考虑了 10 年](https://github.com/golang/go/issues/49085#issuecomment-1290106303)达到如今的成就，那么希望 go 团队能在不违反"[泛型方法在 interface 中的正交性](https://github.com/golang/go/issues/49085#issuecomment-1291237249)🤗"的约束下在下个 10 年实现泛型方法吧。在此之前，如果各位客官想使用泛型方法，请看下面评论(
